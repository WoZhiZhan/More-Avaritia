...
public class ItemEndlessEnergy5 extends Item implements IHaloRenderItem {
    public static ItemEndlessEnergy5 itemEndlessEnergy;
    public ItemEndlessEnergy5() {
        super();
        setUnlocalizedName("endless_energy5");
    ...
    public String getItemStackDisplayName(ItemStack p_77653_1_) {
        return RainbowText.Rainbow("\u65e0\u5c3d\u80fd\u6e90 5");
    }
}
