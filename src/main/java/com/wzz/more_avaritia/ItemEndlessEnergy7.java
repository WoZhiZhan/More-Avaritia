...
public class ItemEndlessEnergy7 extends Item implements IHaloRenderItem {
    public static ItemEndlessEnergy7 itemEndlessEnergy;
    public ItemEndlessEnergy7() {
        super();
        setUnlocalizedName("endless_energy7");
    ...
    public String getItemStackDisplayName(ItemStack p_77653_1_) {
        return RainbowText.Rainbow("\u65e0\u5c3d\u80fd\u6e90 7");
    }
}
