...
public class ItemEndlessEnergy2 extends Item implements IHaloRenderItem {
    public static ItemEndlessEnergy2 itemEndlessEnergy;
    public ItemEndlessEnergy2() {
        super();
        setUnlocalizedName("endless_energy2");
    ...
    public String getItemStackDisplayName(ItemStack p_77653_1_) {
        return RainbowText.Rainbow("\u65e0\u5c3d\u80fd\u6e90 2");
    }
}
