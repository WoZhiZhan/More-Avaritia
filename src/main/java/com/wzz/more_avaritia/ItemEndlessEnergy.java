...
public class ItemEndlessEnergy extends Item implements IHaloRenderItem {
    public static ItemEndlessEnergy itemEndlessEnergy;
    public ItemEndlessEnergy() {
        super();
    ...
    public String getItemStackDisplayName(ItemStack p_77653_1_) {
        return RainbowText.Rainbow("\u65e0\u5c3d\u80fd\u6e90");
    }
}
