...
public class ItemEndlessEnergy6 extends Item implements IHaloRenderItem {
    public static ItemEndlessEnergy6 itemEndlessEnergy;
    public ItemEndlessEnergy6() {
        super();
        setUnlocalizedName("endless_energy6");
    ...
    public String getItemStackDisplayName(ItemStack p_77653_1_) {
        return RainbowText.Rainbow("\u65e0\u5c3d\u80fd\u6e90 6");
    }
}
