...
public class ItemEndlessEnergy4 extends Item implements IHaloRenderItem {
    public static ItemEndlessEnergy4 itemEndlessEnergy;
    public ItemEndlessEnergy4() {
        super();
        setUnlocalizedName("endless_energy4");
    ...
    public String getItemStackDisplayName(ItemStack p_77653_1_) {
        return RainbowText.Rainbow("\u65e0\u5c3d\u80fd\u6e90 4");
    }
}
