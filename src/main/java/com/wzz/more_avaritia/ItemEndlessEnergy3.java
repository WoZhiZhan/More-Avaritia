...
public class ItemEndlessEnergy3 extends Item implements IHaloRenderItem {
    public static ItemEndlessEnergy3 itemEndlessEnergy;
    public ItemEndlessEnergy3() {
        super();
        setUnlocalizedName("endless_energy3");
    ...
    public String getItemStackDisplayName(ItemStack p_77653_1_) {
        return RainbowText.Rainbow("\u65e0\u5c3d\u80fd\u6e90 3");
    }
}
