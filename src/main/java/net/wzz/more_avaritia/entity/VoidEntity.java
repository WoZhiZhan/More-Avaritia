...
public class VoidEntity extends Entity {
  public static final EntityDataAccessor<Integer> AGE_PARAMETER = SynchedEntityData.defineId(VoidEntity.class, EntityDataSerializers.INT);
  public static final GameProfile AVARITIA_FAKE_PLAYER = new GameProfile(UUID.fromString("d93ad14a-a80c-452b-b4f5-42554cf915be"), "[MoreAvaritia]");
  ...
  public VoidEntity(EntityType<VoidEntity> p_19870_, Level p_19871_) {
