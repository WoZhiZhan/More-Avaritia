...
public class ItemCoalSingularity extends ElementsMoreAvaritiaMod.ModElement {
	@GameRegistry.ObjectHolder("more_avaritia:coal_singularity")
	public static final Item block = null;
	public ItemCoalSingularity(ElementsMoreAvaritiaMod instance) {
		super(instance, 71);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelResourceLocation location = new ModelResourceLocation("more_avaritia:coal_singularity", "inventory");
	...
	public static class ItemCustom extends Item implements IHaloRenderItem, IModelRegister {
		public ItemCustom() {
			setMaxDamage(0);
			maxStackSize = 64;
			setUnlocalizedName("coal_singularity");
			setRegistryName("coal_singularity");
